  ...
  <footer class="site-footer">
    <div class="container">
      <div class="footer-inner">
        <div class="logo">
          <a class="footer-inner__logo" href="./index.html">
            <img src="../../assets/logowhite.svg" alt="white-logo-easybank" />
          </a>
          <ul class="footer-inner__list-icon">
            <li class="footer-inner__list-item">
              <a href="#" target="blank" class="footer-inner__list-link">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
        ...
        <ul class="footer-inner__list footer-inner__list--ml">
          <li class="footer-inner__item">
            <a href="#" class="footer-inner__link">About Us</a>
          </li>
          <li class="footer-inner_item">
            <a href="#" class="footer-inner__link">Contact</a>
          </li>
          <li class="footer-inner__item">
            <a href="#" class="footer-inner__link">Blog</a>
          </li>
        </ul>
        <ul class="footer-inner__list">
          <li class="footer-inner__item">
            <a href="#" class="footer-inner__link">Careers</a>
          </li>
          <li class="footer-inner_item">
            <a href="#" class="footer-inner__link">Support</a>
          </li>
          <li class="footer-inner__item">
            <a href="#" class="footer-inner__link">Privacy Policy</a>
          </li>
        </ul>
        <div class="btn-group">
          <div>
...
.site-footer {
  ...
  background-color: var(--main-text-dark-blue-color);
}
.footer-inner {
  display: -webkit-box;
  display: -ms-flexbox;
...
.footer-inner__list-item:last-child {
  margin-right: 0;
}
.footer-inner__list-link:hover svg path {
  fill: #30c88f;
}
.footer-inner__list {
  list-style: none;
